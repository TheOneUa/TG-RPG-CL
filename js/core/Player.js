...
class Player {
    ...
    recalcEqBonus() {
        ...
        // ВАЖНО: используются в бою (computeDamage/hurt), в то время как
        // this.atk/def/maxhp/maxmp остаются "базой" для статов/левелапа/мастеров.
    ...
    _dealDamage(e, parts, floats) {
        ...
        // Похищение жизни (зачарование lifesteal)
    ...
    hurt(dmg, floats) {
        ...
        // Единая формула брони — та же что и для урона по врагам
